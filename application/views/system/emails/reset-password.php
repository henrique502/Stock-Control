				...
				<table cellspacing="0" cellpadding="0" border="0" style="padding:32px 34px 34px;width:100%;background-color:#fff">
					<tr>
						<td>
							...
							<br>
							<div style="color:#000;">
								você pediu para alterar sua senha, use o seguinte link dentro das próximas 24 horas para redefinir sua senha:
								<br><br>
								Seu usuário é <strong><?=$user; ?></strong>
							</div>
							<br>
							<div>
								<a href="<?=site_url('password/edit?code=') . $code; ?>" style="text-align:center;width:160px;min-height:30px;background-color:#00aa00;border:1px solid #136f00;display:inline-block;line-height:30px;text-decoration:none;color:#fff;font-size:14px" target="_blank">Clique aqui</a>
							</div>
						</td>
					</tr>
				</table>
